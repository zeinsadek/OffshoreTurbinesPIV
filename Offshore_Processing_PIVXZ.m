...
recording_name = 'FWF_I_PL2_AK0_A';
...
if exist(paths.wave, 'file')
     ...
     waves = wavedetectionPIVXZ(frames, perspective_path, details, paths.wave);
end
...
if exist(paths.data, 'file')
    ...
    data = vector2matlabPIVXZ(frames, piv_path, paths.data);
end
...
if exist(paths.crop, 'file')
    ...
    crop = croppingPIVXZ(data, waves, details, paths.crop);
end
...
if exist(paths.means, 'file')
     ...
     means = data2meansPIVXZ(crop, paths.means);
end
