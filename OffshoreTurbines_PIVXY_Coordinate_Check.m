...
% PIV_path = "G:\FWF_AK12_Inline_PIVXY\FWF_Inline_PL1_AK12\FWF_I_PL1_AK0_A\StereoPIV_MPd(2x32x32_50%ov)_GPU";
% perspective_path = "F:\PIV\FBT_PL2_AK12_1\FBT_PL2_AK12_LM50_A\ImageCorrection";
% image_name = "B0001";
% 
% PIV = char(fullfile(PIV_path, strcat(image_name, '.vc7')));

data = readimx('G:\FWF_AK12_Inline_PIVXY\FWF_Inline_PL1_AK12\FWF_I_PL1_AK0_A\StereoPIV_MPd(2x32x32_50%ov)_GPU\B00001.vc7');
